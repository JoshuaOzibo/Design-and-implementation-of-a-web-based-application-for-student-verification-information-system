...
import { Users, ShieldCheck, Clock, FileWarning, ScanLine, Search, QrCode, ArrowUpRight } from "lucide-react";
import {
  Table, TableBody, TableCell, TableHead, TableHeader, TableRow,
} from "@/components/ui/table";
import { logs, verificationByType, verificationTrend } from "@/lib/mock-data";
...
const chartColors = ["var(--color-primary)", "var(--color-accent)", "var(--color-warning)"];
void chartColors;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard label="Total Students" value="24,318" delta="+212 this session" icon={Users} tone="primary" />
        <StatCard label="Verified Today" value="1,213" delta="+18% vs. yesterday" icon={ShieldCheck} tone="success" />
        <StatCard label="Active Students" value="22,140" delta="91% of enrolled" icon={ScanLine} tone="accent" />
        <StatCard label="Pending Records" value="86" delta="Awaiting registrar" icon={FileWarning} tone="warning" />
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
          ...
          <CardContent>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={verificationTrend} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
                  <defs>
        ...
        <Card>
          ...
          <CardContent>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={verificationByType} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="var(--color-border)" vertical={false} />
